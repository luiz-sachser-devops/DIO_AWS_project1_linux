...
echo "Creating users, their folders, shell and assigning groups..."
...
echo "Directorie owner and permissions..."

# Root is onwerm of groups and folders
chown root:GRP_ADM /adm
chown root:GRP_VEN /ven
chown root:GRP_SEC /sec

# Root has full access, group members have full access and others have no access
chmod 770 /adm
chmod 770 /ven
chmod 770 /sec
chmod 777 /publico
